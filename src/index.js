 ...
 */
var APP_ID = 'amzn1.ask.skill.8ee22dbf-f86d-4868-bfb4-46eab5c2a319'; //replace with 'amzn1.echo-sdk-ams.app.[your-unique-value-here]';
var PODCAST_APP_ID = `ae2e3addb42eea304949e9757229dd62`; // App ID for Digital Podcast 
 ...
 */
var urlPrefix = 'http://api.digitalpodcast.com/v2r/search?appid=' + PODCAST_APP_ID;
...
/**
 * PodcasterSkill is a child of AlexaSkill.
 * To read more about inheritance in JavaScript, see the link below.
 *
 * @see https://developer.mozilla.org/en-US/docs/Web/JavaScript/Introduction_to_Object-Oriented_JavaScript#Inheritance
 */
var PodcasterSkill = function() {
    AlexaSkill.call(this, APP_ID);
};

// Extend AlexaSkill
PodcasterSkill.prototype = Object.create(AlexaSkill.prototype);
PodcasterSkill.prototype.constructor = PodcasterSkill;

PodcasterSkill.prototype.eventHandlers.onSessionStarted = function (sessionStartedRequest, session) {
    console.log("PodcasterSkill onSessionStarted requestId: " + sessionStartedRequest.requestId
        + ", sessionId: " + session.sessionId);

    // any session init logic would go here
};

PodcasterSkill.prototype.eventHandlers.onLaunch = function (launchRequest, session, response) {
    console.log("PodcasterSkill onLaunch requestId: " + launchRequest.requestId + ", sessionId: " + session.sessionId);
    getWelcomeResponse(response);
};

PodcasterSkill.prototype.eventHandlers.onSessionEnded = function (sessionEndedRequest, session) {
...
PodcasterSkill.prototype.intentHandlers = {
...
function getWelcomeResponse(response) {
    ...
    var cardTitle = "Podcaster";
    var repromptText = "Get the latest podcasts with Podcaster.";
    var speechText = "<p>Podcaster.</p> <p>What podcast are you looking for?</p>";
    var cardOutput = "Podcaster. What podcast are you looking for?";
...
function handleFirstEventRequest(intent, session, response) {
    var repromptText = "Try searching again with Podcaster.";
